        ...
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          <div class="w-full">
            ...
            <div class="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
              ...
              <div class="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                <div class="flex items-center gap-3">
                  ...
                  />
                  <h6 class="font-semibold text-sm lg:text-lg leading-8 text-indigo-600 ">
                    John Watson
                  </h6>
                </div>
                <p class="font-normal text-sm lg:text-lg leading-8 text-gray-400">
                  Nov 01, 2023
                </p>
              </div>
              <p class="font-normal text-sm lg:text-lg leading-8 text-gray-400 max-xl:text-justify">
                I would definitely recommend Floor Masters. From our first
                consultation with them through to completion .Everything went
                smoothly. They were extremely knowledgeable about the product.
                Additionally, they were very responsive when I had additional
                questions and or concerns. The installers were amazing! They
                were professional, punctual and very hard working individuals.
                You can tell they take pride in their work. I cannot say enough
            ...
            <div class="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
              ...
              <p class="font-normal text-sm lg:text-lg leading-8 text-gray-400 max-xl:text-justify">
                Really great service from these guys! Would definitely
                recommend.
              </p>
            </div>
          </div>
